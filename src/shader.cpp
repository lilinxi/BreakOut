...
void Shader::SetMatrix2f(const GLchar *name, const glm::mat2 &matrix, GLboolean useShader) {
    if (useShader) {
        this->Use();
    }
...
void Shader::SetMatrix3f(const GLchar *name, const glm::mat3 &matrix, GLboolean useShader) {
    if (useShader) {
        this->Use();
    }
